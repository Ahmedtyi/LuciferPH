...
3.) add @{Woof.ASSISTANT_NAME } to your group.
...
async def cbstart(_, query: CallbackQuery):
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton(
                    "➕ Add me to your Group ➕", url=f"https://t.me/{Woof.BOT_USERNAME}?startgroup=true")
            ], [
                InlineKeyboardButton(
                ...
                InlineKeyboardButton(
                    "💬 Group", url=f"https://t.me/{Woof.GROUP_NAME}"),
                InlineKeyboardButton(
                    "📣 Channel", url=f"https://t.me/{Woof.CHANNEL_NAME}")
            ], [
                InlineKeyboardButton(
                    "🧙🏻‍♂️ Owner", url=f"https://t.me/{Woof.OWNER_NAME}")
            ], [
                InlineKeyboardButton(
...
👩🏻‍✈️ » [WikiLeaks](https://t.me/TheOnlyMrlucifer)
